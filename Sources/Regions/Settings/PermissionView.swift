            ...
            VStack(alignment: .leading, spacing: 8)
            {
                ...
                Text(
                    authorization.isTrusted
                        ...
                        : "Open Privacy & Security. Choose Device Control and Data Access on this macOS version, or Accessibility on earlier versions. Enable Regions.app itself, not a Tests-Runner app, then return. This window closes when macOS confirms access. Regions does not read window titles, documents, general typing, or screen contents."
                )
