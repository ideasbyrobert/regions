...
struct BalancedThreeByTwoLayout: Sendable
{
    static let capacity = GridDimension.threeByTwo.columnCount
        * GridDimension.threeByTwo.rowCount
    ...
    ) -> BalancedThreeByTwoLayoutResult
    {
        ...
        {
            return .doesNotFit(
                required: CGSize(width: CGFloat.infinity, height: CGFloat.infinity),
        ...
        {
            return .doesNotFit(required: requiredSize, available: visibleFrame.size)
        }
